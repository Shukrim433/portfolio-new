...
const Timeline = () => {
  return (
    <div className="flex flex-col gap-6  justify-center">
        <h2 className="text-2xl md:text-4xl mt-8 mb-2 px-3">MY CAREER TIMELINE<span className="text-red">.</span></h2>
      <div>
        ...
        <div key={role.id}>
          <VerticalTimeline>
            <VerticalTimelineElement
              ...
              contentStyle={role.type == "school" ?  { background: "#0c0a09", color: "#ffffff" } : { background: "#0c0a09", color: "#ffffff" }}
